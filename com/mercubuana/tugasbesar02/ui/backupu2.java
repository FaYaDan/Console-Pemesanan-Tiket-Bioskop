...
public class FormBioskopXXX {
	...
	void hapusData() {
		...
		Film FilmDipilihPadaList = (Film) listDaftarFilm
				.getModel().getElementAt(index);
		//2. Meminta User untuk Confirmasi
		...
		if (indeksDataDipilih==jumlahFilm-1 &&
				jumlahFilm >= 2) {
			/*indeks yang dipilih adalah yang terahir dalam List
			 * dan masih ada sisa kamar belum di hapus
			 * di dalam List
			 * */
			indeksDataDipilih -=1;
		} else if (indeksDataDipilih==0 &&
				jumlahFilm>= 2){
		/* Yang dipilih adalah yang terahir
		 * dan masih ada sisa kamar belum dihapus
		 * di dalam list
		 */
		indeksDataDipilih = -1;
		} 
