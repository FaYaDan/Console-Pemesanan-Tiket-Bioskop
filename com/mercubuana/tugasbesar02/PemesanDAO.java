...
public class PemesanDAO {
	...
	public static Pemesan loadPemesanByORMID(PersistentSession session, int idPemesan) throws PersistentException {
		try {
			return (Pemesan) session.load(com.mercubuana.tugasbesar02.Pemesan.class, Integer.valueOf(idPemesan));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Pemesan getPemesanByORMID(PersistentSession session, int idPemesan) throws PersistentException {
		try {
			return (Pemesan) session.get(com.mercubuana.tugasbesar02.Pemesan.class, Integer.valueOf(idPemesan));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Pemesan loadPemesanByORMID(PersistentSession session, int idPemesan, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Pemesan) session.load(com.mercubuana.tugasbesar02.Pemesan.class, Integer.valueOf(idPemesan), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Pemesan getPemesanByORMID(PersistentSession session, int idPemesan, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Pemesan) session.get(com.mercubuana.tugasbesar02.Pemesan.class, Integer.valueOf(idPemesan), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryPemesan(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From com.mercubuana.tugasbesar02.Pemesan as Pemesan");
		if (condition != null)
	...
	public static Pemesan createPemesan() {
		return new com.mercubuana.tugasbesar02.Pemesan();
	}
	
	public static boolean save(com.mercubuana.tugasbesar02.Pemesan pemesan) throws PersistentException {
		try {
	...
	public static boolean delete(com.mercubuana.tugasbesar02.Pemesan pemesan) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(com.mercubuana.tugasbesar02.Pemesan pemesan)throws PersistentException {
		try {
			if (pemesan.getFilmid_film() != null) {
				pemesan.getFilmid_film().pemesan.remove(pemesan);
			}
	...
	public static boolean deleteAndDissociate(com.mercubuana.tugasbesar02.Pemesan pemesan, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (pemesan.getFilmid_film() != null) {
				pemesan.getFilmid_film().pemesan.remove(pemesan);
			}
	...
	public static boolean refresh(com.mercubuana.tugasbesar02.Pemesan pemesan) throws PersistentException {
		try {
	...
	public static boolean evict(com.mercubuana.tugasbesar02.Pemesan pemesan) throws PersistentException {
		try {
